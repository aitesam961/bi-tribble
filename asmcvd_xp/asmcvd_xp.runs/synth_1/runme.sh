...
HD_PWD='/home/aitesam961/GitHub/bi-tribble/asmcvd_xp/asmcvd_xp.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log asmcvd_xp.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source asmcvd_xp.tcl
